...
if __name__ == '__main__':
    ...
    *********************************************************
    ...
    """
    img_feats = np.load('./data/AmazonBeauty/visual_feat.npy')
    txt_feats = np.load('./data/AmazonBeauty/text_feat.npy')
    ...
    for epoch in range(args.epoch):
        ...
        with torch.no_grad():
            ...
            if best_recall < test_ret['recall'][-1]:
                ...
                u_g_embeddings_id, i_g_embeddings_id, u_g_embeddings_txt, i_g_embeddings_txt, u_g_embeddings_img, i_g_embeddings_img = _model.get_embeddings()
                u_g_embeddings_id = u_g_embeddings_id.detach().cpu().numpy()
                i_g_embeddings_id = i_g_embeddings_id.detach().cpu().numpy()
                np.save('./data/AmazonBeauty/Beauty_HSD_user_id', u_g_embeddings_id)
